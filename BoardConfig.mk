DEVICE_TREE := device/lenovo/kuntao_row
...
# Boot image
BOARD_KERNEL_CMDLINE := console=null androidboot.hardware=qcom msm_rtb.filter=0x237 ehci-hcd.park=3 lpm_levels.sleep_disabled=1 androidboot.bootdevice=7824900.sdhci cma=32M@0-0xffffffff androidboot.selinux=permissive enforcing=0
...
#     BOARD_USERDATAIMAGE_PARTITION_SIZE          := 25631374336 // Don't change size when building TWRP
#     else
#     Actual size is 25631374336
...
#TARGET_SPECIFIC_HEADER_PATH := device/lenovo/kuntao_row/include
# disabled for now
